...
public class JavaWebSocket implements IWebSocket {
    ...
    public void sendAnswer(String socketId, String sdp) {
        ...
        childMap2.put("roomId", roomid);

        HashMap<String, Object> map = new HashMap();
        map.put("eventName", "_answer");
    ...
    public void sendIceCandidate(String socketId, IceCandidate iceCandidate) {
        ...
        childMap.put("sdpMid", iceCandidate.sdpMid);
        childMap.put("sdpMLineIndex", iceCandidate.sdpMLineIndex);
        childMap.put("sdp", iceCandidate.sdp);
        childMap.put("socketId", socketId);
        childMap.put("roomId", roomid);
        HashMap<String, Object> map = new HashMap();
        map.put("eventName", "_ice_candidate");
        map.put("data", childMap);
        JSONObject object = new JSONObject(map);
        String jsonString = object.toString();
        Log.d(TAG, "send-->" + jsonString);
    ...
    private void handleRemoteCandidate(Map map) {
        ...
        if (data != null) {
            ...
            int sdpMLineIndex = (int) data.get("sdpMLineIndex");
