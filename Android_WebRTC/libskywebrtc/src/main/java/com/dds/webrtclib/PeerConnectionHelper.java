    ...
    private class Peer implements SdpObserver, PeerConnection.Observer {
        ...
        public void onSetSuccess() {
            ...
            if (pc.signalingState() == PeerConnection.SignalingState.HAVE_REMOTE_OFFER) {
                ...
                SessionDescription.Type type = pc.getLocalDescription().type;
                String sdp = pc.getLocalDescription().description;
                if (type == SessionDescription.Type.ANSWER) {//响应者,发送自己的answer
                    _webSocket.sendAnswer(socketId, sdp);
                } else if (type == SessionDescription.Type.OFFER) {//发送者,发送自己的offer
